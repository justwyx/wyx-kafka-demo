package com.wyx.kafkademo.consumer.test3;
...
public class AsyncManualConsumer extends ShutdownableThread {
    ...
    public AsyncManualConsumer() {
        ...
        String brokers = "kafka1:9092,kafka2:9093,kafka3:9094";
        // 指定kafka集群
        properties.put("bootstrap.servers", brokers);
        // 指定消费者组ID
        properties.put("group.id", "wyxGroupTest");
    ...
    public void doWork() {
        // 订阅消费主题
        consumer.subscribe(Collections.singletonList("wyx-topic-demo"));
