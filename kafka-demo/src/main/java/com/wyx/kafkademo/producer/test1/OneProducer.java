package com.wyx.kafkademo.producer.test1;
...
//        properties.put("retry.backoff.ms", 100);// 两次重试之间的时间间隔 默认为100ms
		...
		properties.put("partitioner.class", "com.wyx.kafkademo.producer.MyPartitioner");
	...
	public void sendMsg() {
		...
		ProducerRecord<Integer, String> record = new ProducerRecord<>("wyx-topic-demo", 0, 1, "hangzhou");
